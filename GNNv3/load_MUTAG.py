...
# load numpy from txt
path = r"C:\Users\ehabo\Downloads\DrugSideEffects-main\DrugSideEffects-main\GNNv3\MUTAG_raw"
edgesIDs = np.loadtxt(r"C:\Users\ehabo\Downloads\DrugSideEffects-main\DrugSideEffects-main\GNNv3\MUTAG_raw\Mutagenicity_edges.txt",dtype=int, delimiter=',')
edgesL = np.loadtxt(r"C:\Users\ehabo\Downloads\DrugSideEffects-main\DrugSideEffects-main\GNNv3\MUTAG_raw\Mutagenicity_edge_labels.txt",dtype=int)
nodesL = np.loadtxt(r"C:\Users\ehabo\Downloads\DrugSideEffects-main\DrugSideEffects-main\GNNv3\MUTAG_raw\Mutagenicity_node_labels.txt",dtype=int)
gIDs_nodes = np.loadtxt(r"C:\Users\ehabo\Downloads\DrugSideEffects-main\DrugSideEffects-main\GNNv3\MUTAG_raw\Mutagenicity_graph_indicator.txt",dtype=int)
gtargs = np.loadtxt(r"C:\Users\ehabo\Downloads\DrugSideEffects-main\DrugSideEffects-main\GNNv3\MUTAG_raw\Mutagenicity_graph_labels.txt",dtype=int)
