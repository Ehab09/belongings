...
class CGNNnodeBased(BaseCGNN):
	...
	# -----------------------------------------------------------------------------------------------------------------
	def get_weights(self) -> tuple[list[list[list[np.array]]], list[list[np.array]]]:
		return [[net_state.get_weights()] for net_state in self.net_state_list], [self.net_output.get_weights()]

	# -----------------------------------------------------------------------------------------------------------------
	def set_weights(self, weights_state: list[list[list[np.array]]], weights_output: list[list[np.array]]) -> None:
	...
	## LOOP METHODS ###################################################################################################
	# @tf.function
	def type_loop_condition(self, i, *args) -> tf.Tensor:
	...
	# -----------------------------------------------------------------------------------------------------------------
	# @tf.function
	def condition(self, k, *args) -> tf.Tensor:
